...
|-- all_prompts_index.json       # Catalog index of all 316 prompts
...
|   |-- prompts.csv              # CSV spreadsheet export of all 316 prompts
|   |-- prompts.json             # Complete dataset for all 316 prompts
...
|   └── prompts/                 # 316 individual prompt JSON files
|-- prompts/                     # 316 standalone HTML pages, 1.html to 319.html
└── uploads/                     # 450 local thumbnails, storyboards, and community images
```
...
- Existence of all 316 static prompt HTML pages in prompts/.
- Zero broken relative links across all 325 HTML files.
- Zero remaining external soniprompts.com references in HTML and JSON datasets.
- Verification that all 450 referenced image assets exist locally on disk.
- Prompt text completeness across all 316 entries in data/prompts.json.
