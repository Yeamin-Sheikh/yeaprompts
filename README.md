...
A complete replica and prompt library for YeaPrompts. All 289 prompt pages, master prompt instructions, and 404 media assets are stored and accessible both online and offline.
...
- All 289 prompts with full text, categories, updated dates, and storyboard reference images.
...
- Individual static pages for all 289 prompts with word count, character count, and one-click clipboard copying.
- Replicated pages for home, community feed, pricing, contact, privacy policy, terms of service, and refund policy.
- Zero external image dependencies. All 404 thumbnail and storyboard images and 5 site assets are stored locally.
...
|-- all_prompts_index.json       # Catalog index of all 289 prompts
...
|   |-- prompts.csv              # CSV spreadsheet export of all 289 prompts
|   |-- prompts.json             # Complete dataset for all 289 prompts
...
|   └── prompts/                 # 289 individual prompt JSON files
|-- prompts/                     # 289 standalone HTML pages (1.html to 291.html)
└── uploads/                     # 404 local thumbnails, storyboards, and community images
```
...
- Existence of all 289 static prompt HTML pages in prompts/.
- Zero broken relative links across all 298 HTML files.
- Zero remaining external soniprompts.com references in HTML and JSON datasets.
- Verification that all 404 referenced image assets exist locally on disk.
- Prompt text completeness across all 289 entries in data/prompts.json.
