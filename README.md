...
A complete replica and prompt library for YeaPrompts. All 307 prompt pages, master prompt instructions, and 432 media assets are stored and accessible both online and offline.
...
- All 307 prompts with full text, categories, updated dates, and storyboard reference images.
...
- Individual static pages for all 307 prompts with word count, character count, and one-click clipboard copying.
- Replicated pages for home, community feed, pricing, contact, privacy policy, terms of service, and refund policy.
- Zero external image dependencies. All 432 thumbnail and storyboard images and 5 site assets are stored locally.
...
|-- all_prompts_index.json       # Catalog index of all 307 prompts
...
|-- db/
|   |-- index.js                 # Node.js SQLite repository, getPrompts, getCategories, and getStats
...
|   |-- prompts.csv              # CSV spreadsheet export of all 307 prompts
|   |-- prompts.json             # Complete dataset for all 307 prompts
...
|   └── prompts/                 # 307 individual prompt JSON files
|-- prompts/                     # 307 standalone HTML pages, 1.html to 309.html
└── uploads/                     # 432 local thumbnails, storyboards, and community images
```
...
- Existence of all 307 static prompt HTML pages in prompts/.
- Zero broken relative links across all 317 HTML files.
- Zero remaining external soniprompts.com references in HTML and JSON datasets.
- Verification that all 432 referenced image assets exist locally on disk.
- Prompt text completeness across all 307 entries in data/prompts.json.
